...
void ofApp::setup(){
    ...
    gui.add(scalar1.setup("gradient force", 0.001, 0, 0.1));
    gui.add(scalar2.setup("anchor force", 0.34, 0, 1));
    gui.add(scalar3.setup("random noise", 0, 0, 1));
    gui.add(scalar4.setup("current velocity", 0.25, 0, 1));
